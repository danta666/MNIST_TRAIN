...
with tf.Session(graph=myGraph) as sess:
    ...
    summary_writer = tf.summary.FileWriter('./mnistEven/', graph=sess.graph)#mnistEven文件夹中的内容用来tensorboard可视化 

    for i in range(30000):#这里循环3万次
    ...
    saver.save(sess,'这里写需要保存模型的路径',global_step=1)
